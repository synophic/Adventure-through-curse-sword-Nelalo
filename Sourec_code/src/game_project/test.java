...
public class test {
    ...
    public class Fireball implements Asset {
        ...
        public Fireball(Wizard wizard) throws IOException {
            fireball = ImageIO.read(getClass().getResource("src/resource/Sprite/Char/Knight/knight.png"));
    ...
    public class Wizard implements Asset {
        ...
        public Wizard() throws IOException {
            wizard = ImageIO.read(getClass().getResource("/src/resource/Sprite/Char/Knight/knight.png"));
